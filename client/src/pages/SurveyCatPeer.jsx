// client/src/pages/SurveyCatPeer.jsx
// ─────────────────────────────────────────────────────────────────────────────
...
import "../assets/SurveyCatPeer.css";   // ← same content as survey2.css
...
const CATEGORIES = {
  1: {
    ...
    scale:     "jobperf",   // Poor / Unsatisfactory / Satisfactory / Very Good / Outstanding
    questions: [
  ...
  6: {
    ...
    questions: [
      ...
      { id: "peer6.3", text: "Enables co-workers to grow and succeed through feedback, instruction, and encouragement." },
      { id: "peer6.4", text: "Gains others\u2019 support for ideas, proposals, projects, and solutions." },
      { id: "peer6.5", text: "Develops, maintains, and strengthens partnerships with others inside or outside the organization who can provide information, assistance, and support." },
      { id: "peer6.6", text: "Effectively coordinates ideas and resources to achieve goals." },
      { id: "peer6.7", text: "Manages staff in ways that improve their ability to succeed on the job." },
      { id: "peer6.8", text: "Uses knowledge of the organizational and political climate to solve problems and accomplish goals." },
    ],
  },
  7: {
    ...
    scale:     "functional",
    questions: [
      { id: "peer7.1",  text: "Articulates our team\u2019s purpose and goals." },
      { id: "peer7.2",  text: 'Does what is right and not what is "right for me".' },
      { id: "peer7.3",  text: "Acknowledges that success or failure is a shared result." },
      { id: "peer7.4",  text: "Freely communicates with peers." },
      { id: "peer7.5",  text: "Makes plans before executing a project." },
      { id: "peer7.6",  text: "Accomplishes tasks on or before the deadline." },
      { id: "peer7.7",  text: "Aims for zero mistakes." },
      { id: "peer7.8",  text: "Meets our clients\u2019 requirements." },
      { id: "peer7.9",  text: "Shares knowledge and best practices with our co-workers." },
...
// Legend table has 5 columns; voting radios still include N/A option
const SCALE_JOBPERF = {
  legendCols: 5,
  ...
  // Each radio: { value, idSuffix, divClass, divLabel }
  // idSuffix is the part after "prcXqY" — e.g. "rad1", "rad1.5", "radNA"
  radios: [
...
//   id attr      : "prc{catNum}q{qNum}{idSuffix}"  e.g. "prc4q1rad1", "prc4q2rad1.5"
// =============================================================================
